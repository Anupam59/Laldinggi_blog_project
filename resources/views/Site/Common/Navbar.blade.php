        ...
        <div class="container px-0">
            <div class="topbar-top d-flex justify-content-between flex-lg-wrap">
                <div class="top-info flex-grow-0">
                    ...
                    <div class="overflow-hidden TrendingWidth">
                        <div id="note" class="ps-2">
                            <img src="{{asset('Site/img/features-fashion.jpg')}}" class="img-fluid rounded-circle border border-3 border-primary me-2" style="width: 30px; height: 30px;" alt="">
            ...
            <nav class="navbar navbar-light navbar-expand-xl">
                ...
                <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                    <div class="navbar-nav mx-auto border-top">
                        ...
                        <a href="/details" class="nav-item nav-link">DetailPage</a>
                        <a href="/category" class="nav-item nav-link">Category</a>
                        <a href="404.html" class="nav-item nav-link">404Page</a>
                        <a href="404.html" class="nav-item nav-link">404Page</a>
                    ...
                    <div class="d-flex flex-nowrap border-top pt-3 pt-xl-0">
                        <div class="d-flex">
                            <img src="{{asset('Site/img/weather-icon.png')}}" class="img-fluid me-2" style="width: 35px; height: 35px" alt="">
                            <div class="d-flex align-items-center">
                                <strong class="fs-6 text-secondary">31°C</strong>
                                <div class="d-flex flex-column ms-2" style="width: 100px;">
                                    <span class="text-body" style="font-size: 12px;">NEW YORK,</span>
                                    <small style="font-size: 10px;">Mon. 10 jun 2024</small>
                                </div>
                            </div>
                        </div>
