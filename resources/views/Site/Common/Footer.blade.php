    ...
    <div class="container py-5">
        <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(255, 255, 255, 0.08);">
            <div class="row g-4">
                ...
                <div class="col-lg-9">
                    <div class="d-flex position-relative rounded-pill overflow-hidden BannerSubscribe">
                ...
                <div class="footer-item-2">
                        ...
                        <a href="#">
                            <div class="d-flex align-items-center">
                                <div class="rounded-circle border border-2 border-primary overflow-hidden">
                                    <img src="{{asset('Site/img/footer-1.jpg')}}" class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                </div>
                    ...
                    <div class="d-flex flex-column">
                        <a href="#">
                            <div class="d-flex align-items-center">
                                <div class="rounded-circle border border-2 border-primary overflow-hidden">
                                    <img src="{{asset('Site/img/footer-2.jpg')}}" class="img-zoominimg-fluid rounded-circle w-100" alt="">
                                </div>
                                <div class="d-flex flex-column ps-4">
                    ...
                    <div class="row g-2">
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('Site/img/footer-1.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('Site/img/footer-2.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('Site/img/footer-3.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('Site/img/footer-4.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('Site/img/footer-5.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('Site/img/footer-6.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                        </div>
                    </div>
                </div>
