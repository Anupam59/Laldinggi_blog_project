            ...
            <!-- Default box -->
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        ...
                        <table class="table table-striped projects">
                            ...
                            @foreach($NewsStatus as $key=>$NewsStatusItem)

                                <tr>
                                    <td>{{ $key+1 }}</td>

                                    <td>
                                        <a>{{ $NewsStatusItem->news_status_title }}</a>
                                    </td>

                                    <td>
                                        <a>{{ $NewsStatusItem->news_status_slug }}</a>
                                    </td>

                                    <td class="project-state">
                                        @if($NewsStatusItem->status == 1)
                                            <span class="badge badge-success">Active</span>
                                        @elseif($NewsStatusItem->status == 2)
                ...
                <div class="row">
                    <div class="col d-flex align-items-center justify-content-center">
                        {{ $NewsStatus->onEachSide(3)->links('Admin.Common.Paginate') }}
                    </div>
                </div>
