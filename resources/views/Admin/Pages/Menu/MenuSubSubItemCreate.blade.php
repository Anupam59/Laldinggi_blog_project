    ...
    <div class="content-wrapper" style="min-height: 1604.08px;" data-select2-id="31">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Menu Sub Sub Item Create</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/admin/') }}/dashboard">Dashboard</a></li>
                            <li class="breadcrumb-item active">Menu Sub Sub Item Create</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('admin/menu-sub-sub-item-entry') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" class="form-control" value="{{ old('menu_sub_sub_item_title') }}" name="menu_sub_sub_item_title" placeholder="Title">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('menu_sub_sub_item_bn_title') }}" name="menu_sub_sub_item_bn_title" placeholder="Title (বাংলা)">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Link</label>
                                        <input type="text" class="form-control" value="{{ old('menu_sub_sub_item_link') }}" name="menu_sub_sub_item_link" placeholder="Title">
                                    </div>
                                </div>
