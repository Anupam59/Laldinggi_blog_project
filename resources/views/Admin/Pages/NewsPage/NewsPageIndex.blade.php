            ...
            <!-- Default box -->
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-danger btn-sm add_btn" href="{{ url('/admin/') }}/news-page-create">
                            ...
                            @foreach($NewsPage as $key=>$NewsPageItem)
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-primary btn-sm" href="{{ url('/admin/') }}/news-page-edit/{{ $NewsPageItem->news_page_id }}">
