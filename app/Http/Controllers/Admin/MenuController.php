...
class MenuController extends Controller
{
    ...
    public function MenuSubItemCreate(){
        ...
        $MenuItem = MenuItemModel::where('status',1)->select('menu_item_id','menu_item_title')->get();
    ...
    public function MenuSubItemEdit($id){
        ...
        return view('Admin/Pages/Menu/MenuSubItemUpdate',compact('Menu','MenuItem','MenuSubItem'));
    }
